...
let colours = ['yellow', 'yellow', 'green', 'green', 'red', 'red', 'orange', 'orange', 'purple', 'purple', 'pink', 'pink', 'brown', 'brown', 'blue', 'blue', 'darkRed', 'darkRed', 'darkGreen', 'darkGreen', 'lime', 'lime', 'darkBlue', 'darkBlue', 'darkOrange', 'darkOrange', 'lightPurple', 'lightPurple', 'paleYellow', 'paleYellow', 'coral', 'coral', 'darkPink', 'darkPink', 'white', 'white'];
let coloursOrdered = [];
let coloursClicked = [];
...
function reset() {
    ...
    colours = ['yellow', 'yellow', 'green', 'green', 'red', 'red', 'orange', 'orange', 'purple', 'purple', 'pink', 'pink', 'brown', 'brown', 'blue', 'blue', 'darkRed', 'darkRed', 'darkGreen', 'darkGreen', 'lime', 'lime', 'darkBlue', 'darkBlue', 'darkOrange', 'darkOrange', 'lightPurple', 'lightPurple', 'paleYellow', 'paleYellow', 'coral', 'coral', 'darkPink', 'darkPink', 'white', 'white'];
    coloursOrdered = [];
    coloursClicked = [];
    clickedCounter = 0;
    flipped = false;
...
function flip(elementId) {
    ...
    iscomplete = complete(); // checks if game is over
        if (iscomplete == true && message == false) {
            ...
            document.cookie = cookies + ":" + " completed Hard difficulty in " + minutes + "m " + seconds + "s using " + clickedCounter + " clicks";
        }
    }, 500);
}